 <?php 
    ...
    $this_admin_roles = getWhere('tbl_site_manager_roles','site_manager_id',$_SESSION["crm_credentials"]['user_id']);
 ...
 <!-- ========== Left Sidebar Start ========== -->
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft" style="overflow-y: scroll;">
                    ...
                    <div id="sidebar-menu" >
                        <ul>
                           <li class="menu-title" align="center">SITE MANAGER</li>

                            <li>
                                <a href="../../modules/site_manager/dashboard.php" class="waves-effect"><i class="ti-dashboard"></i><span> Dashboard </span> </a>
                            </li>
                            <li>
                                <a href="../../modules/site_manager/my_site.php" class="waves-effect"><i class="ti-dashboard"></i><span> My Site </span> </a>
                            </li>
                           <!--  
                            <li>
