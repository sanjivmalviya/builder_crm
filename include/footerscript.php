    ...
    <script>
         ...
         $(document).on('click','.active-inactive-btn', function(){
         

            var table = $(this).attr('data-record-table'); 
            var id = $(this).attr('data-record-id');
            var current_status = $(this).attr('data-record-status'); 

            $.ajax({
               url : '../../ajax/change_status.php',
               type : 'POST',
               dataType : 'JSON',
               data : { table : table, id : id, current_status : current_status },
         ...
         $(document).on('click','.app-access-btn', function(){
            
            // applied on view employees
            ...
            $.ajax({
               url : '../../ajax/change_app_access_status.php',
               type : 'POST',
               dataType : 'JSON',
               data : { table : table, id : id, current_status : current_status },
               success : function(data){
