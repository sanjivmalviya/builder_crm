...
<?php
   ...
   $sources = getAll('tbl_lead_sources_master');

   $table_name = 'tbl_lead_sources_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_lead_sources_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_lead_sources_master',$form_data)){              
   			$success = "State Addded Successfully";
         }else{
                     ...
                     <table class="table table-striped table-condensed table-bordered">
                        ...
                        <tbody>
                           <?php if(isset($sources)){ ?>
                              <?php foreach($sources as $rs){ ?>

                                 <tr>
                                    <td><?php echo $rs['name']; ?></td>
                                    <td class="text-right">
                                       <a href="lead_source.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="lead_source.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
