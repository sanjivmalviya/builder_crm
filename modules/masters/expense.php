...
<?php
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_expense_master','name',$name)){
                           ...
                           <?php if(isset($expenses)){ ?>
                              <?php foreach($expenses as $rs){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right">
                                       <a href="expense.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="expense.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
