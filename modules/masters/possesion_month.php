...
<?php
   ...
   $months = getAll('tbl_possesion_month_master');

   $table_name = 'tbl_possesion_month_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_possesion_month_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_possesion_month_master',$form_data)){              
   			$success = "Month Addded Successfully";
         }else{
            $error = "Failed to Add month";
   		}		   		
   ...
   if(isset($_GET['delete_id'])){
      ...
      if(delete($table_name,$field_name,$_GET['delete_id'])){
         ...
         header('location:possesion_month.php');
      }else{
                           ...
                           <?php if(isset($months)){ ?>
                              <?php foreach($months as $rs){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right">
                                       <a href="possesion_month.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="possesion_month.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
