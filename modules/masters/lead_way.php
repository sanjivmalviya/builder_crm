...
<?php
   ...
   $ways = getAll('tbl_inquiry_ways_master');

   $table_name = 'tbl_inquiry_ways_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_inquiry_ways_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_inquiry_ways_master',$form_data)){              
   			$success = "Inquiry Way Addded Successfully";
         }else{
               ...
               <div class="container">
                   <div class="row">
                     <div class="col-md-6">
                        <div class="page-title-box">
                           <h4 class="page-title">Inquiry Way</h4>
                  ...
                  <div class="row">
                     ...
                     <table class="table table-striped table-condensed table-bordered">
                        ...
                        <tbody>
                           <?php if(isset($ways)){ ?>
                              <?php foreach($ways as $rs){ ?>

                                 <tr>
                                    <td><?php echo $rs['name']; ?></td>
                                    <td class="text-right">
                                       <a href="inquiry_way.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="inquiry_way.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
