...
<?php
   ...
   $property_categories = getAll('tbl_property_categories_master');

   $table_name = 'tbl_property_categories_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_property_categories_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_property_categories_master',$form_data)){              
   			$success = "Property Category Addded Successfully";
         }else{
            $error = "Failed to Add Property Category";
   		}		   		
   ...
   if(isset($_GET['delete_id'])){
      ...
      if(delete($table_name,$field_name,$_GET['delete_id'])){
         ...
         header('location:property_category.php');
      }else{
                   ...
                   <div class="row">
                     <div class="col-md-6">
                        <div class="page-title-box">
                           <h4 class="page-title">Property Categories</h4>
                           ...
                           <?php if(isset($property_categories)){ ?>
                              <?php foreach($property_categories as $rs){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right">
                                       <a href="property_category.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="property_category.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
