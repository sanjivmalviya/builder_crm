...
<?php
   ...
   $property_types = getAll('tbl_property_types_master');

   $table_name = 'tbl_property_types_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_property_types_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_property_types_master',$form_data)){              
   			$success = "Property type Addded Successfully";
         }else{
                           ...
                           <?php if(isset($property_types)){ ?>
                              <?php foreach($property_types as $rs){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right">
                                       <a href="property_type.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="property_type.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
