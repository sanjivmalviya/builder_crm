...
<?php
   ...
   $table_name = 'tbl_possesion_statuses_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_possesion_statuses_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_possesion_statuses_master',$form_data)){              
   			$success = "Possesion Status Addded Successfully";
         }else{
   ...
   if(isset($_GET['delete_id'])){
      ...
      if(delete($table_name,$field_name,$_GET['delete_id'])){
         ...
         header('location:possesion_status.php');
      }else{
                   ...
                   <div class="row">
                     <div class="col-md-6">
                        <div class="page-title-box">
                           <h4 class="page-title">Possesion Statuses</h4>
                                    ...
                                    <div class="row">
                                    	...
                                    	<div class="col-md-4">
                                          <div class="form-group">
                                             <label for="name">Possesion Status Name<span class="text-danger">*</span></label>
                           ...
                           <?php if(isset($possesion_statuses)){ ?>
                              <?php foreach($possesion_statuses as $rs){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right">
                                       <a href="possesion_status.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="possesion_status.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
