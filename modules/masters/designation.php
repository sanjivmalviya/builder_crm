...
<?php
   ...
   $table_name = 'tbl_designation_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_designation_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_designation_master',$form_data)){              
   			$success = "Designation Addded Successfully";
         }else{
                           ...
                           <?php if(isset($designations)){ ?>
                              <?php foreach($designations as $rs){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right">
                                       <a href="Designation.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="designation.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
