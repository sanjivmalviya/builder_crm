...
<?php
   ...
   $table_name = 'tbl_sample_house_options_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_sample_house_options_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_sample_house_options_master',$form_data)){              
   			$success = "Sample House Option Addded Successfully";
         }else{
            $error = "Failed to Add Sample House Option";
   		}		   		
   ...
   if(isset($_GET['delete_id'])){
      ...
      if(delete($table_name,$field_name,$_GET['delete_id'])){
         ...
         header('location:sample_house_option.php');
      }else{
               ...
               <div class="container">
                   <div class="row">
                     <div class="col-md-6">
                        <div class="page-title-box">
                           <h4 class="page-title">Sample House Option</h4>
                  ...
                  <div class="row">
                     ...
                     <table class="table table-striped table-condensed table-bordered">
                        ...
                        <tbody>
                           <?php if(isset($sample_house_options)){ ?>
                              <?php foreach($sample_house_options as $rs){ ?>

                                 <tr>
                                    <td><?php echo $rs['name']; ?></td>
                                    <td class="text-right">
                                       <a href="sample_house_option.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="sample_house_option.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
