...
<?php
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_amenity_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_amenity_master',$form_data)){              
                           ...
                           <?php if(isset($amenities)){ ?>
                              <?php foreach($amenities as $rs){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right">
                                       <a href="amenity.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="amenity.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
