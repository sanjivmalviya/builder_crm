...
<?php
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_states_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_states_master',$form_data)){              
                           ...
                           <?php if(isset($states)){ ?>
                              <?php foreach($states as $rs){ ?>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right">
                                       <a href="state.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="state.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
