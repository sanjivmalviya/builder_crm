...
<?php
   ...
   $years = getAll('tbl_possesion_year_master');

   $table_name = 'tbl_possesion_year_master';
   $field_name = 'id';
   ...
   if(isset($_POST['submit'])){
      ...
      if(isExists('tbl_possesion_year_master','name',$name)){

   			$error = "Oops ! Name already exists, try a different one";

      }else{
   
         if(insert('tbl_possesion_year_master',$form_data)){              
   			$success = "Year Addded Successfully";
         }else{
   ...
   if(isset($_GET['delete_id'])){
      ...
      if(delete($table_name,$field_name,$_GET['delete_id'])){
         ...
         header('location:possesion_year.php');
      }else{
               ...
               <div class="container">
                                    ...
                                    <div class="row">
                                    	...
                                    	<div class="col-md-4">
                                          <div class="form-group">
                                             <label for="name">Year Name<span class="text-danger">*</span></label>
                  ...
                  <div class="row">
                     ...
                     <table class="table table-striped table-condensed table-bordered">
                        ...
                        <tbody>
                           <?php if(isset($years)){ ?>
                              <?php foreach($years as $rs){ ?>

                                 <tr>
                                    <td><?php echo $rs['name']; ?></td>
                                    <td class="text-right">
                                       <a href="possesion_year.php?edit_id=<?php echo $rs['id']; ?>"><i class="fa fa-pencil"></i></a>
                                       <a href="possesion_year.php?delete_id=<?php echo $rs['id']; ?>" onclick=" return confirm('Are you sure ?'); "><i class="fa fa-trash"></i></a>
                                    </td>
                                 </tr>
