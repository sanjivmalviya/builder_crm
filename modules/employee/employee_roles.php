<?php
   ...
   $id = $_GET['employee_id'];
   $admin = getOne('tbl_employees','id',$id);
   $employee_name = $admin['name'];

   $menus = ('SELECT * FROM tbl_menus WHERE user_type = "1" ORDER BY menu_id ASC ');
   $menus = getRaw($menus);

   $roles = getWhere('tbl_employee_roles','employee_id',$id);
   ...
   if(isset($_POST['submit'])){
      ...
      delete('tbl_employee_roles','employee_id',$id);
      ...
      if(isset($_POST['role_access']) && !empty($_POST['role_access'])){
         ...
         foreach($_POST['role_access'] as $role){
               ...
               if(insert('tbl_employee_roles',$form_data)){
                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title"><small>Manage Role for </small><?php echo $employee_name; ?></h4>
