<?php
   ...
   if(isset($_GET['search'])){
      ...
      $leads = " SELECT * FROM tbl_leads WHERE delete_status = '0' ".$condition." ORDER BY id ASC ";

   }else{

      $leads = " SELECT * FROM tbl_leads WHERE delete_status = '0' AND `date` = '".$today."' ";
                ...
                <div class="col-md-12">
                    ...
                    <form method="GET">
                      ...
                      <div class="col-md-12 pt-2">
                        <p><?php if($leadCount > 0){ echo "<span class='text-primary text-bold'>".$leadCount." Records Found </span>"; }else{ echo "<span class='text-danger text-bold'>No Records Found</span>"; }  ?></p>
                  ...
                  <?php if(isset($leads) && count($leads) > 0){ ?>
                    <?php foreach($leads as $rs){ ?>
                        <tr>
                          ...
                          <td><?php 
                                  $lead_status = getLeadStatus($rs['lead_status']); 
                                  echo "<span class=".$lead_status['status_class_light'].">".$lead_status['lead_status']."</span>"; 
                                ?>
                          </td>
                          <td><?php echo getleadSource($rs['lead_source_id']); ?></td>
                    </tr>
                    <?php } ?>
                    <?php } ?>
                </tbody>
