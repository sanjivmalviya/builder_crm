<?php
   ...
   $id = $_GET['site_manager_id'];
   $admin = getOne('tbl_site_managers','id',$id);
   $admin_name = $admin['admin_name'];

   $menus = ('SELECT * FROM tbl_menus ORDER BY menu_id ASC ');
   $menus = getRaw($menus);

   $roles = getWhere('tbl_site_manager_roles','site_manager_id',$id);
   ...
   if(isset($_POST['submit'])){
      ...
      delete('tbl_site_manager_roles','site_manager_id',$id);
      ...
      if(isset($_POST['role_access']) && !empty($_POST['role_access'])){
         ...
         foreach($_POST['role_access'] as $role){
               ...
               if(insert('tbl_site_manager_roles',$form_data)){
